...
[Cate Heine](https://scholar.google.com/citations?user=rWS08wIAAAAJ&hl=en) is a Research Fellow in urban mobility and inequality who joined CASA and the realTRIPS project in February 2024. Before joining CASA, Cate completed her PhD in Social & Engineering Systems at MIT, where she was a research assistant in the [Senseable City Lab](https://senseable.mit.edu/). Her research focuses on using large-scale human mobility datasets to study the impact of urban design choices on social mixing and experienced segregation in cities. More generally, she is interested in the relationship between the built environment, sustainable transportation, and equitable access to urban amenities.

[Fulvio Lopane](https://fdlop.com/) is a Research Fellow in Urban Modelling who joined the realTRIPS project in 2024. He joined UCL CASA in 2020 to work as Research Fellow in Urban and Trasport Modelling. He holds a PhD in Civil Engineering from Newcastle University, specialising is spatial optimisation for infrastructure services' resilience to natural disasters and changing climates. He investigates different aspects of urban science applied to the development of sustainable infrastructure systems and accessible urban spaces and services. His ongoing research focusses on infrastructure networks, human mobility, urban modelling and software development of spatial optimisation frameworks, spatial interaction platforms and land use analysis tools.
